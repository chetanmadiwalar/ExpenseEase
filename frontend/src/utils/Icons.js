...
export const transactions = <i className="fa-solid fa-receipt"></i>
...
export const Budget = <i className="fa-solid fa-wallet"></i>
export const set = <i className="fa-solid fa-sliders-h"></i>
